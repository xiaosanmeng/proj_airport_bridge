...
# 4. 获取高度的最小值和最大值用于颜色映射（包括高度为0的点）
height_data = pvg_flights['HE']
...
for flight in unique_flights:
    ...
    # 提取所有轨迹点
    coords = flight_data[['LA', 'LO', 'HE']].values.tolist()
...
# 10. 保存地图到HTML文件
m.save('flight_tracks_map_all.html')

print("地图已生成并保存为 'flight_tracks_map_all.html'")
